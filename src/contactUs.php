...
<div class="bigboi">
    <div class="container">
        <div class="contactInfo flex-item">
            ...
            <p> For support or any questions, emails us at <a href="mailto:qscu.ubco@gmail.com?Subject=QSCU%20Shop"
                                                              target="_top">qscu.ubco@gmail.com</a></p>
            <div class="address">
        ...
        <form id="contactForm" method="post" action="https://formspree.io/qscu.ubco@gmail.com" class="flex-item">
            <fieldset>
                ...
                <div class="formElement">
                    ...
                    <textarea id="messageInput" name="message" placeholder="Your Message" rows="4" maxlength="200"
                              required></textarea>
                </div>

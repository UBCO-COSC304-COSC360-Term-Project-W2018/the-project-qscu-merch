    ...
    <main>
        <div id="container">
            ...
            <div id="productList">
                ...
                <div id="productContent">
                    ...
                    <table class="productItem">
                        <tr>
                            <td class="productName"><span>product1</span></td>
                            <td class="productSize"><span>Size</span></td>
                            <td class="productPrice"><span>Price</span></td>
                            <td class="productQuantity"><span>Quantity</span></td>
                        </tr>
                        <tr>
                    ...
                    <table class="productlist">
                        <tr>
                            <td class="productName"><span>single item</span></td>
                            <td class="productSize"><span>Size</span></td>
                            <td class="productPrice"><span>Price</span></td>
                            <td class="productQuantity"><span>Quantity</span></td>
                        </tr>
            ...
            <div class="hidden" id="userList">
                <div>
                    <h1 class="userHead">Product List</h1>
                </div>
                <div id="userContent">
                    <!--                    TODO style me-->
                    <!--                    the table is created dynamically and repeats do not use ids only classes and tag selection-->

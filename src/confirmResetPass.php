...
<main>
    <div id="forms">
        <form id="newPassForm" method="post" action="action/editUser.php">
            <!--TODO: give this form an action that can nicely update a user's password -->
            <fieldset>
                ...
                <?php else: ?>
                    ...
                    <div id="loginFormInputElements">
                        ...
                        <div class="SUformElement">
                            <label id="SUconfirmPasswordLabel" class="signUpLabel"
                                   for="signUpPasswordConfirmationInput">Confirm Password: </label>

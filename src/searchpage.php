...
<main>
    <div id="main">
            ...
            <form id="refineform">
                <fieldset id="refinefieldset">
                    ...
                    <div id="itemsperpage">
                        ...
                        <output name="price" for="max"></output>
                        <br>
                    </div>
        ...
        <div id="categoryviews">
            <div id="sortby">
                <p id='searchResultsTitle'>Search
                    Results<?php if (isset($_GET['Search'])) echo " for: &quot;" . $_GET['Search'] . "&quot;"; ?></p>
                <!--could include what we searched for in this line. Simple Query, extra -->
                <form id="sortform">
            ...
            <div id="resultHolder">
                <input type="hidden" id="searchTransferForLoad"
